...
import (
	...
	"github.com/googleapis/repo-automation-bots/packages/bazelbot2/postprocessor/execv/gocmd"
...
func (p *postProcessor) Manifest() (_ map[string]ManifestEntry, err error) {
	defer derrors.Wrap(&err, "Manifest")
...
func docURL(cloudDir, importPath, relPath string) (_ string, err error) {
	defer derrors.Wrap(&err, "docURL(%q, %q, %q)", cloudDir, importPath, relPath)
