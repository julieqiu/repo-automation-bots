...
// internalCompanyClient is an interface that defines the methods available from Google Ad Manager API.
type internalCompanyClient interface {
	Close() error
	setGoogleClientInfo(...string)
	Connection() *grpc.ClientConn
	GetCompany(context.Context, *admanagerpb.GetCompanyRequest, ...gax.CallOption) (*admanagerpb.Company, error)
	ListCompanies(context.Context, *admanagerpb.ListCompaniesRequest, ...gax.CallOption) *CompanyIterator
	GetOperation(context.Context, *longrunningpb.GetOperationRequest, ...gax.CallOption) (*longrunningpb.Operation, error)
}

// CompanyClient is a client for interacting with Google Ad Manager API.
...
// GetCompany aPI to retrieve a Company object.
func (c *CompanyClient) GetCompany(ctx context.Context, req *admanagerpb.GetCompanyRequest, opts ...gax.CallOption) (*admanagerpb.Company, error) {
	return c.internalClient.GetCompany(ctx, req, opts...)
}

// ListCompanies aPI to retrieve a list of Company objects.
func (c *CompanyClient) ListCompanies(ctx context.Context, req *admanagerpb.ListCompaniesRequest, opts ...gax.CallOption) *CompanyIterator {
...
// GetCompany aPI to retrieve a Company object.
func (c *companyRESTClient) GetCompany(ctx context.Context, req *admanagerpb.GetCompanyRequest, opts ...gax.CallOption) (*admanagerpb.Company, error) {
...
// ListCompanies aPI to retrieve a list of Company objects.
func (c *companyRESTClient) ListCompanies(ctx context.Context, req *admanagerpb.ListCompaniesRequest, opts ...gax.CallOption) *CompanyIterator {
	it := &CompanyIterator{}
	req = proto.Clone(req).(*admanagerpb.ListCompaniesRequest)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	it.InternalFetch = func(pageSize int, pageToken string) ([]*admanagerpb.Company, string, error) {
		resp := &admanagerpb.ListCompaniesResponse{}
		if pageToken != "" {
		...
		baseUrl.Path += fmt.Sprintf("/v1/%v/companies", req.GetParent())
