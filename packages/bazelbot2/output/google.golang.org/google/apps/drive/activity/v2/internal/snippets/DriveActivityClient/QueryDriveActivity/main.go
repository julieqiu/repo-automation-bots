...
// [START driveactivity_v2_generated_DriveActivityService_QueryDriveActivity_sync]
...
func main() {
	...
	for {
		...
		_ = it.Response.(*activitypb.QueryDriveActivityResponse)
	}
}

// [END driveactivity_v2_generated_DriveActivityService_QueryDriveActivity_sync]
