...
func defaultGRPCClientOptions() []option.ClientOption {
	return []option.ClientOption{
		...
		internaloption.WithDefaultEndpointTemplate("library-example.UNIVERSE_DOMAIN:443"),
...
// internalClient is an interface that defines the methods available from Example Library API.
...
func defaultRESTClientOptions() []option.ClientOption {
	return []option.ClientOption{
		internaloption.WithDefaultEndpoint("https://library-example.googleapis.com"),
		internaloption.WithDefaultEndpointTemplate("https://library-example.UNIVERSE_DOMAIN"),
		internaloption.WithDefaultMTLSEndpoint("https://library-example.mtls.googleapis.com"),
		internaloption.WithDefaultUniverseDomain("googleapis.com"),
		internaloption.WithDefaultAudience("https://library-example.googleapis.com/"),
		internaloption.WithDefaultScopes(DefaultAuthScopes()...),
		internaloption.EnableNewAuthLibrary(),
