...
func file_google_apps_drive_labels_v2beta_label_lock_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_apps_drive_labels_v2beta_label_lock_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_apps_drive_labels_v2beta_label_lock_proto_msgTypes[1].Exporter = func(v any, i int) any {
