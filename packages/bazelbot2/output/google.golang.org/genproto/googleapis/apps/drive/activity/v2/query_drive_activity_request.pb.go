...
func file_google_apps_drive_activity_v2_query_drive_activity_request_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_apps_drive_activity_v2_query_drive_activity_request_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_apps_drive_activity_v2_query_drive_activity_request_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_apps_drive_activity_v2_query_drive_activity_request_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_apps_drive_activity_v2_query_drive_activity_request_proto_msgTypes[3].Exporter = func(v any, i int) any {
