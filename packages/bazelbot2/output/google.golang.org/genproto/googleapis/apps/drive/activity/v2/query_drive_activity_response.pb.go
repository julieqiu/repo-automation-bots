...
func file_google_apps_drive_activity_v2_query_drive_activity_response_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_apps_drive_activity_v2_query_drive_activity_response_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_apps_drive_activity_v2_query_drive_activity_response_proto_msgTypes[1].Exporter = func(v any, i int) any {
