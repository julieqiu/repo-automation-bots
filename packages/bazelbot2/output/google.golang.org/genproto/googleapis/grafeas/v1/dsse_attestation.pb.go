...
func file_grafeas_v1_dsse_attestation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_grafeas_v1_dsse_attestation_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_grafeas_v1_dsse_attestation_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_grafeas_v1_dsse_attestation_proto_msgTypes[2].Exporter = func(v any, i int) any {
