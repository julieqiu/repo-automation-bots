...
var file_google_devtools_remoteworkers_v1test2_worker_proto_goTypes = []any{
...
func file_google_devtools_remoteworkers_v1test2_worker_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_devtools_remoteworkers_v1test2_worker_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Worker); i {
			case 0:
				return &v.state
			case 1:
		...
		file_google_devtools_remoteworkers_v1test2_worker_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Device); i {
			case 0:
				return &v.state
			case 1:
		...
		file_google_devtools_remoteworkers_v1test2_worker_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_devtools_remoteworkers_v1test2_worker_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_google_devtools_remoteworkers_v1test2_worker_proto_msgTypes[4].Exporter = func(v any, i int) any {
