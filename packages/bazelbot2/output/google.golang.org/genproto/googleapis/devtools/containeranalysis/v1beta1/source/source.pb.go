...
var file_google_devtools_containeranalysis_v1beta1_source_source_proto_rawDesc = []byte{
	...
	0x4e, 0x61, 0x6d, 0x65, 0x42, 0x7d, 0x0a, 0x19, 0x69, 0x6f, 0x2e, 0x67, 0x72, 0x61, 0x66, 0x65,
	0x61, 0x73, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x50, 0x01, 0x5a, 0x58, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x67, 0x6f, 0x2f, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e,
	0x65, 0x72, 0x61, 0x6e, 0x61, 0x6c, 0x79, 0x73, 0x69, 0x73, 0x2f, 0x61, 0x70, 0x69, 0x76, 0x31,
	0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x61,
...
var file_google_devtools_containeranalysis_v1beta1_source_source_proto_goTypes = []any{
...
func file_google_devtools_containeranalysis_v1beta1_source_source_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_devtools_containeranalysis_v1beta1_source_source_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_devtools_containeranalysis_v1beta1_source_source_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_devtools_containeranalysis_v1beta1_source_source_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_devtools_containeranalysis_v1beta1_source_source_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_google_devtools_containeranalysis_v1beta1_source_source_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_google_devtools_containeranalysis_v1beta1_source_source_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*RepoId); i {
			case 0:
				return &v.state
			case 1:
		...
		file_google_devtools_containeranalysis_v1beta1_source_source_proto_msgTypes[6].Exporter = func(v any, i int) any {
	...
	file_google_devtools_containeranalysis_v1beta1_source_source_proto_msgTypes[0].OneofWrappers = []any{
		(*SourceContext_CloudRepo)(nil),
		(*SourceContext_Gerrit)(nil),
		(*SourceContext_Git)(nil),
	}
	file_google_devtools_containeranalysis_v1beta1_source_source_proto_msgTypes[2].OneofWrappers = []any{
		(*CloudRepoSourceContext_RevisionId)(nil),
		(*CloudRepoSourceContext_AliasContext)(nil),
	}
	file_google_devtools_containeranalysis_v1beta1_source_source_proto_msgTypes[3].OneofWrappers = []any{
		(*GerritSourceContext_RevisionId)(nil),
		(*GerritSourceContext_AliasContext)(nil),
	}
	file_google_devtools_containeranalysis_v1beta1_source_source_proto_msgTypes[5].OneofWrappers = []any{
