...
var file_google_compute_logging_gdnsusage_v1_gdns_vm_usage_proto_goTypes = []any{
...
func file_google_compute_logging_gdnsusage_v1_gdns_vm_usage_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_compute_logging_gdnsusage_v1_gdns_vm_usage_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_compute_logging_gdnsusage_v1_gdns_vm_usage_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*VmInfo); i {
			case 0:
				return &v.state
			case 1:
	...
	file_google_compute_logging_gdnsusage_v1_gdns_vm_usage_proto_msgTypes[0].OneofWrappers = []any{}
	file_google_compute_logging_gdnsusage_v1_gdns_vm_usage_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
