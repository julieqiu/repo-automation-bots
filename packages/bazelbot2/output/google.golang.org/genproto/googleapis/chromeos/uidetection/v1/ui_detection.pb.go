...
func file_google_chromeos_uidetection_v1_ui_detection_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_chromeos_uidetection_v1_ui_detection_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_chromeos_uidetection_v1_ui_detection_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_chromeos_uidetection_v1_ui_detection_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_chromeos_uidetection_v1_ui_detection_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_google_chromeos_uidetection_v1_ui_detection_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_google_chromeos_uidetection_v1_ui_detection_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_google_chromeos_uidetection_v1_ui_detection_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_google_chromeos_uidetection_v1_ui_detection_proto_msgTypes[7].Exporter = func(v any, i int) any {
